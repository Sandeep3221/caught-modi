  ...
  <table>
    <tr>
      <td align="center" valign="middle" width="50%">
        <img src="Screenshot%202026-07-12%20162405.png" width="100%" alt="Game Preview">
      </td>
      <td align="center" valign="middle" width="50%">
        <img src="modi%20image.png" width="100%" alt="Modi Sprite">
      </td>
    </tr>
  </table>
</div>
...
- **Responsive Controls**: Fully playable on both Desktop and Mobile!
  - **Desktop**: Use `Arrow Keys` or `W/A/S/D` to dodge left/right. Press `Up` or `Space` to jump, and `Down` to fast-fall!
  - **Mobile**: Swipe `Left/Right` to switch lanes, swipe `Up` to jump, and swipe `Down` for a rapid drop.
